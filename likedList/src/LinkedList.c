...
static Node* getNode(LinkedList* this, int nodeIndex)
{
	...
	if (this != NULL && tamLista > nodeIndex && nodeIndex > -1)
	{
		nodoReturn = (Node*) malloc (sizeof(Node));
...
int ll_remove(LinkedList* this, int index)
{
    ...
    if (this != NULL && index >-1 && index < tamLista && index > -1)
    {
    	//2 casos: que sea el primero o que sea cualquier otro
    ...
    if (this != NULL && index >-1 && index < tam )
    {
    	...
    	else
    	{
    		if (index > 0)
    		{
    			...
    			nodoAnterior->pNextNode = nodePop->pNextNode;
    			this->size = tam -1;
    		}
    	}
    }
...
LinkedList* ll_subList(LinkedList* this, int from, int to)
{
    ...
    listReturn = (LinkedList*) malloc (sizeof(LinkedList));
    listReturn = calloc (sizeof(LinkedList), 1);
    ...
    if (this != NULL)
    {
    	if (from>-1 && from < tamLista && to>= from && to <tamLista)
    	{
    		for (i=from; i<to+1; i++)
    		{
    			...
    			if (element != NULL)
    			{
    				retornoLlAdd = ll_add (listReturn, element);
    				if (retornoLlAdd == -1)
    				{
    					listReturn = NULL;
    				}
...
LinkedList* ll_clone(LinkedList* this)
{
    ...
    if (this != NULL)
    {
    	...
    	listaClonada = ll_subList (this, 0, tam-1);
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if (this!=NULL)
    {
    	...
    	for (i=0; i <tamLista-1; i++)
    	{
    		...
    		{
    			element1 = (void*) malloc (sizeof(void));
    			element2 = (void*) malloc (sizeof(void));
